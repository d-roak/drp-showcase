...
export default function GridPlayers(props: { peerId: string; grid: GridDRP | null; gridEl: React.RefObject<HTMLDivElement>; rerender: number; setRerender: (rerender: number) => void }) {
